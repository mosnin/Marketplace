  ...
  return (
    <article className="space-y-10">
      ...
      <p className="text-sm leading-6 text-muted-foreground">
        Welcome to Koala. These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between you and
        Koala Inc. (&quot;Koala,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) governing your access to and use of the Koala platform
        available at usekoala.com and my.usekoala.com (the &quot;Service&quot;). By accessing or using the Service, you agree
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>3.1. <strong className="text-foreground">Free Trial.</strong> New Subscribers are eligible for a 7-day free trial. During the trial period, you will have access to the full features of the Service, including AI lead scoring, deal pipelines, appointment scheduling, voice AI assistant, and MCP server integration. No payment is required during the trial.</p>
          ...
          <p>3.5. <strong className="text-foreground">Payment Processing.</strong> All payments are processed by Stripe. By subscribing, you agree to Stripe&apos;s terms of service. Koala does not store your full payment card details.</p>
      ...
      {/* 6. Intellectual Service */}
      <section>
        <h2 className="text-xl font-semibold">6. Intellectual Service</h2>
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>6.1. The Service, including all software, design, text, graphics, interfaces, and underlying technology, is the exclusive service of Koala Inc. and is protected by intellectual service laws.</p>
          ...
          <p>6.3. Koala, the Koala logo, and all related names, logos, and slogans are trademarks of Koala Inc. You may not use them without our prior written consent.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <p>7.2. By using the Service, you grant Koala a limited license to process, store, and transmit your Content solely as necessary to provide, maintain, and improve the Service.</p>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <p>8.3. Koala is not responsible for the practices or availability of third-party services.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <p>9.3. Koala does not guarantee the accuracy, completeness, or reliability of any AI-generated output. Subscribers are solely responsible for any decisions they make based on AI features.</p>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <p>10.2. KOALA SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, BUSINESS OPPORTUNITIES, OR GOODWILL, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE SERVICE.</p>
          <p>10.3. IN NO EVENT SHALL KOALA&apos;S TOTAL AGGREGATE LIABILITY EXCEED THE AMOUNT YOU HAVE PAID TO KOALA IN THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO THE CLAIM.</p>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>11.1. You agree to indemnify, defend, and hold harmless Koala Inc., its officers, directors, employees, and agents from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys&apos; fees) arising out of or related to:</p>
          <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>12.1. <strong className="text-foreground">Informal Resolution.</strong> Before initiating any formal dispute resolution, you agree to contact us at <a href="mailto:help@usekoala.com" className="underline hover:text-foreground">help@usekoala.com</a> to attempt to resolve the dispute informally for a period of at least thirty (30) days.</p>
          ...
          <p>12.4. <strong className="text-foreground">Exceptions.</strong> Either party may seek injunctive or equitable relief in a court of competent jurisdiction to protect intellectual service rights or prevent irreparable harm.</p>
        </div>
      </section>
