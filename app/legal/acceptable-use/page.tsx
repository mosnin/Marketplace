export const metadata = {
  ...
  description: 'Acceptable Use Policy for Koala, a B2B SaaS agentic OS for real estate agents and agencies.',
};
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Not infringe upon the intellectual service rights of any third party.</li>
