...
export const metadata: Metadata = { title: 'My Leads — Koala' };
...
export default async function MyLeadsPage() {
    ...
    return (
      <div className="space-y-6 max-w-5xl mx-auto pb-56 md:pb-24">
        <header className="space-y-1.5">
          ...
          <p className={BODY_MUTED}>{agency.name} hasn&rsquo;t routed anything yet.</p>
        </header>
  ...
  // Query contacts with tag 'assigned-by-agency'
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-56 md:pb-24">
      ...
      {leads.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border/70 bg-muted/20 px-5 py-12 text-center">
          ...
          <p className={cn(BODY_MUTED, 'mt-1.5')}>
            When {agency.name} routes a lead to you, I&rsquo;ll land it here.
          </p>
        </div>
      ) : (
