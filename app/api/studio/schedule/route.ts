...
/** The provider's connected social accounts — active toolkits that live in
...
export async function POST(req: NextRequest) {
  ...
  // Hourly per-provider cap so a script can't flood StudioPost / Inngest.
  ...
  // Only allow platforms the provider has actually connected.
