 ...
 *
 * The provider-facing entry point: auth, subscription gate, and rate limiting
 * live here; the upload is stored as a File and the transform runs in the
 * shared core (lib/studio/edit.ts), which the Koala agent's internal route
 * reuses.
 */
...
export async function POST(req: NextRequest) {
  ...
  // checkStudioSpendBudget reflects the provider's total day's burn.
