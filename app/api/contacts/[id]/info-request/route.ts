...
/**
 * POST /api/contacts/[id]/info-request — provider asks a client to send
 ...
 *
 * Provider auth via requireContactAccess (the protected-system pattern) — the
 * provider must own the space the contact belongs to.
 */
