/**
 * POST   /api/profile-page/cover-photo — upload the provider's public-page cover photo.
...
export async function POST(req: NextRequest) {
  ...
  // The DELETE handler intentionally keeps the object so the provider can
...
export async function DELETE() {
  ...
  // We don't delete the underlying object — the provider may want to revert,
