...
export async function POST(req: NextRequest) {
  ...
  // Notify provider via email (fire and forget)
  notifyProviderOfMessage(contact.spaceId, contact.name, sanitized).catch((err) =>
    console.error('[portal/message] Provider notification failed:', err),
  );
...
/**
 * Send email notification to provider about new applicant message.
 */
async function notifyProviderOfMessage(
  spaceId: string,
