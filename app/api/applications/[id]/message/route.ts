 ...
 *
 * Auth'd endpoint for providers to send messages to applicants.
 * Creates an ApplicationMessage with senderType: 'provider'.
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden">
        ...
        <tr><td style="padding:16px 28px;border-top:1px solid #f1f5f9">
          <p style="margin:0;font-size:11px;color:#9ca3af">This email was sent by ${safeBizName} via Koala</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
