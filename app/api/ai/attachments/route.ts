 ...
 *
 * The provider drops a file into the prompt box; the client posts it here, we
 ...
 *  the provider to keep editing the message and short enough that the URL
...
export async function POST(req: NextRequest) {
  ...
  // Sign a short-lived URL so the provider's inline preview renders. The
