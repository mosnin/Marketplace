/**
 * Conversation CRUD for the agency Koala surface.
 *
 * Parallel to `app/api/ai/conversations/route.ts` (the provider route) but
 * gated on agency access via `resolveAgencyContext()` (defense layer 2).
 *
