 ...
 * AgentDraft records ahead of the provider opening the app.
 *
 ...
 * The provider approves drafts in the FocusCard; only that approval flow
 * fires outbound channels.
 *
 * Auth: Bearer ${CRON_SECRET} (matches agency-weekly-report).
