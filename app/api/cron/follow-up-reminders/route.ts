 ...
 *
 * Daily at 9 AM UTC. Emails + texts providers a digest of contacts whose
 * followUpAt has come due in the last 24 hours.
 *
 * Idempotency: a SETNX day-lock prevents a duplicate cron invocation
 * (Vercel retry, manual re-trigger) from double-blasting every provider
...
async function handler(req: NextRequest) {
  ...
  // Day-level idempotency. The provider schedule revolves around days,
