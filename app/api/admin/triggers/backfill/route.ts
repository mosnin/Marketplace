 ...
 * time, but providers who connected BEFORE the triggers feature shipped
 * have active connections with zero IntegrationTrigger rows. Without
 * this, their Koala never notices anything until they reconnect.
 *
 ...
 * facing. (If we ever want to expose it to agencies as a manual "rewire
 * my Koala" button, that's a separate route with Clerk auth.)
 *
...
export async function POST(req: NextRequest) {
  ...
  // Only ACTIVE connections — expired/revoked rows mean the provider
