 ...
 * The provider taps "Send a check-in" on the home, this composes a draft
 * inline and returns it; the UI shows it; the provider taps Send and the
 ...
 * everything else is email — that's the provider's primary outbound rail and
 * the only one the chat tool fires today. The provider can always Edit →
