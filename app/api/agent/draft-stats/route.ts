 ...
 *
 * Tells the provider (and the agent itself) how its drafts have actually been
 * landing. Two layers of signal:
 *
 *   - Input quality (Phase 12): `feedback_action`, `edit_distance`, `decision_ms`
 *     — did the provider approve / edit / reject the draft. Lives in the
 ...
 *
 * Math lives in `lib/draft-stats.ts` so the agency dashboard's "Draft impact"
