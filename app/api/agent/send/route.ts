 ...
 *     of "the provider's whole contact list gets spammed at 03:00."
 */
 ...
 *  (a multi-action post-appointment batch, a multi-stage drip resuming) while
 ...
 *  provider's contacts, not the underlying transport. */
