 ...
 *
 * The composed morning story for the /koala home. Returns counts AND named
 ...
 *
 * Provider space only — agency-routed contacts (agencyId !== null) are
 * excluded so the provider's morning briefing reflects what's on _their_
