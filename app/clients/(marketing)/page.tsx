    ...
    <main className="mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-3xl flex-col justify-center px-4 py-16 sm:px-6">
      <div className="max-w-xl space-y-6">
        <h1
          ...
          style={TITLE_FONT}
        >
          Track your application. Book appointments. Message your agent.
        </h1>
        <p className="text-sm leading-relaxed text-muted-foreground">
          One place for everything you have in motion with a provider — wherever
          you applied, whatever you&apos;re appointmenting. Sign in with the email you
