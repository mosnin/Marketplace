 ...
 * `/demo` — book a demo.
 *
 * One focal element: the scheduler. A agency or team evaluating Koala
 ...
 * signed-in provider doesn't need to book a sales walkthrough.
 *
...
export const metadata = { title: 'Book a demo · Koala' };
