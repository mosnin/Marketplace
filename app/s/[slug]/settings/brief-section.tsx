...
/**
 * Brief settings — two switches the provider cares about, no more.
 *
 *   On / Off  — opt out of the daily brief entirely.
 *   Time      — hour of day in the provider's timezone.
 *
 ...
 * sentence on the morning surface; if a provider wants more knobs,
...
export function BriefSection({ slug }: BriefSectionProps) {
  ...
  // provider changes something. Saving a no-op is a small lie ("I saved
