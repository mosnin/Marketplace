 ...
 *
 * One intent: a provider submits a support request. The form is the focal
 * element; the provider's own past tickets sit below it with status badges.
 *
 ...
 * provider has to operate — just say what's wrong and send it.
 */
