...
// app/agency/reviews/reviews-client.tsx (formatRelative) to keep styling
...
export function ReviewsClient({ slug, initialReviews }: Props) {
  ...
  const emptyCopy = (t: Tab): string => {
    if (t === 'open') {
      return 'No reviews in flight. Flag a deal for agency review from the deal page when you want a second set of eyes.';
    }
    if (t === 'resolved') {
  ...
  return (
    <div className="space-y-4">
      {/* Tabs — visual pattern mirrors app/agency/reviews/reviews-client.tsx */}
