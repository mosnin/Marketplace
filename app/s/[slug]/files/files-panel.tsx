...
interface FileRow {
   ...
   *  by removing the attachment inside the Koala conversation. */
  source: 'file' | 'chat';
  ...
  const handleFiles = useCallback(
    async (incoming: File[]) => {
      ...
      try {
        ...
        // Hold the full bar for a beat so the provider sees the finish
...
function FileCard({
  ...
  return (
    ...
    >
      {/* The thumbnail itself is the click target so the provider doesn't
      ...
      >
        ...
        <div className="p-2.5 space-y-0.5">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {file.source === 'chat' && (
              <span
                title="Uploaded inside a Koala conversation"
