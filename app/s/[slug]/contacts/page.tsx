...
/**
 * Read-only fetch of the provider's own deals + stages for the performance
 ...
 * the provider's overall output, not a single pipeline. Never writes.
 *
...
export default async function ContactsPage({
  ...
  // of the "messy top" the provider flagged.
  //
