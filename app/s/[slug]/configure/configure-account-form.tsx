...
export function ConfigureAccountForm({ initialData, slug }: ConfigureAccountFormProps) {
  ...
  const [providerPhotoUrl, setProviderPhotoUrl] = useState(initialData.providerPhotoUrl || '');
  ...
  const [photoPreview, setPhotoPreview] = useState(initialData.providerPhotoUrl || '');
  ...
  async function handlePhotoUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (url) { setProviderPhotoUrl(url); setPhotoPreview(url); }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section id="section-branding" className="rounded-xl border border-border bg-card px-5 py-5 scroll-mt-4">
          <SectionHeader
            icon={Image}
            title="Branding"
            description="Customize how your intake and appointment booking pages look to prospects."
          />
          <div className="space-y-4">
            <div className="space-y-1.5">
              <Label>Logo</Label>
            ...
            <div className="space-y-1.5">
              ...
              >
                {photoPreview || providerPhotoUrl ? (
                  <img src={photoPreview || providerPhotoUrl} alt="Photo preview" className="w-12 h-12 rounded-full object-cover ring-2 ring-border" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                ) : (
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium">{providerPhotoUrl ? 'Change photo' : 'Upload photo'}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="space-y-0">
                {[
                  { id: 'service', label: 'Service Selection', locked: true },
