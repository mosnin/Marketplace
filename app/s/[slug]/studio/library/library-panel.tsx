...
/**
 * LibraryPanel — /s/[slug]/studio/library. A gallery of the provider's past
...
export function LibraryPanel() {
  ...
  // grid happens only after the provider confirms in the toast.
  ...
  return (
    <div className="space-y-4">
      {/* Header CTA — the provider's eye lands here after scanning past
