 ...
 * lands in the provider's Files library, and generation cost is metered into
...
export function CreatePanel({
  ...
  // Duplicate flow: the provider opened this panel from a Library tile and
  ...
  async function handleGenerate() {
    ...
    // outlives the in-page spinner if the provider scrolls or switches tabs.
