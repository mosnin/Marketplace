...
export default async function ServicesPage({
  ...
  try {
    ...
    console.error('[services/page] DB query failed', { slug, error: err });
    fetchError = true;
  }
      ...
      <div className="flex min-h-[50vh] items-center justify-center">
        <div className="text-center space-y-4 p-8">
          ...
          <p className={cn(BODY_MUTED)}>
            We couldn&apos;t load your services. This is usually temporary.
          </p>
          <a
  ...
  return (
    <div className={cn('space-y-6 mx-auto pb-12', PAGE_MAX)}>
      ...
      {services.length === 0 ? (
        ...
        /* divide-y row list — mirrors the deal-service-picker pattern.
           Thumbnail (4:3 ~128px) + facts on the right. A service list is
           a working register, not a gallery; rows let the provider scan
