/**
 * /cma/[token] — the PUBLIC, polished CMA report a provider shares with a seller.
 *
 ...
 * report renders the frozen `payload`, so it stays stable even if the provider
 * later edits or deletes the underlying Service rows.
 *
 ...
 * clean table, the provider's workspace name as the only branding. Print-friendly
