...
Koala is well past initial build. The CRM substrate, public intake, lead scoring, appointments, the agency tier, and the autonomous agent are all shipped and in use.
...
| Chat / cockpit UX | The provider's chat surface — live status, tool-call rendering, the instrument/cockpit pass |
| Billing & usage | Per-seat agency billing is in place; usage metering and plan enforcement for the agent are being built |
