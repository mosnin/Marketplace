...
Manual validation playbook for Koala.
...
| Stripe | Agency billing (`/api/billing/*`) | `STRIPE_PRICE_STARTER`, `STRIPE_PRICE_TEAM`, `STRIPE_PRICE_ENTERPRISE` (+ the Stripe secret/webhook vars) |
...
- [ ] Contact type filter (QUALIFICATION, APPOINTMENT, APPLICATION) works
