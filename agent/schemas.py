...
ContactType = Literal["QUALIFICATION", "APPOINTMENT", "APPLICATION"]
...
class AgentSettings(BaseModel):
    ...
    enabled-agents list have all been retired — Koala is one agent and
    ...
    # Provider-picked primary chat model (OpenRouter slug). None = app default.
