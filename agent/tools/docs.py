...
Call when the provider asks how to use a feature, why something isn't
...
async def recall_docs(
    ...
    # category: contacts|deals|services|appointments|calendar|koala|settings|troubleshooting.
