"""Priority list tool — ranked daily focus list for the provider.
...
async def generate_priority_list(
    ...
    # +10 active goal, +8 appointment stage, -10 contacted <24h, -20 no email/phone.
    ...
    for c in contacts:
        ...
        # Appointment contact
        if c.get("type") == "APPOINTMENT":
            score += 8
            reasons.append("appointment stage")
