...
-- This is the user-facing "Files" page surface — anything the provider
...
-- Hot path: provider's Files page query → spaceId + recency.
...
-- Per-user quota query for agencies (multiple providers share a Space).
