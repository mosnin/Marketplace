...
-- meant the attacker had read-only Composio-MCP access to the provider's
...
--     enough that providers who set-and-forget don't break their Claude
...
--     (e.g. now() + 1y) and notify providers. Not done here — that's a
