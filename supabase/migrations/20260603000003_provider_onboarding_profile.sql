-- Extend AIUserProfile with the fields captured by the new provider onboarding:
--   role          — solo agent / team lead / agency owner
--   zipCode       — primary market ZIP, used by Koala for market context
--   leadSources   — channels the provider uses to acquire leads (zillow, facebook, …)
--
