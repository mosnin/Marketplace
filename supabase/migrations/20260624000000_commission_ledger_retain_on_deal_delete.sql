-- ============================================================================
-- CommissionLedger: retain the agency's commission books when a Deal is
...
-- record the agency owns and may need for payout reconciliation, disputes,
...
-- with dealId = NULL; the agency's books stay intact. agencyId keeps
-- ON DELETE CASCADE — deleting the whole agency tenant still clears its
