-- Enhanced onboarding fields for providers and agencies

-- Provider profile fields on User table
ALTER TABLE "User"
  ...
  ADD COLUMN IF NOT EXISTS "agencyAffiliation" text,
...
ALTER TABLE "Agency"
  ...
  ADD COLUMN IF NOT EXISTS "agencyType" text
    CHECK ("agencyType" IN ('independent', 'franchise', 'virtual')),
