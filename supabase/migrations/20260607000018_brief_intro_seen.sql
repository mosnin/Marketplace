-- briefIntroSeenAt — the provider's first-ever brief carries a one-line
...
--
-- Nullable so existing providers who got briefs before this column was
...
-- intro line for ~existing providers~ to avoid backfill complexity.
