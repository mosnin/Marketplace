-- Support tickets — a provider submits a help request from inside the app; it
-- lands in the admin dashboard where an admin triages it.
--
-- spaceId / userId link the ticket to the submitting provider's workspace and
...
-- Provider "my tickets" view filters by the submitting user, newest-first.
