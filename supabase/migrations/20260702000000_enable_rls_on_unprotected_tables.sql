...
-- through PostgREST. The tables below hold workspace/PII data (agency<->Koala
...
-- Realtime touches only Contact / Deal / DealStage / Appointment, already scoped in
...
ALTER TABLE IF EXISTS "AgencyConversation"    ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AgencyMessage"         ENABLE ROW LEVEL SECURITY;
