-- Intake trust signals: optional provider-supplied compliance slots that
-- render in the public intake chat footer. Koala provides the rendering
-- slot; the provider/agency supplies the actual legal text — we never
-- inject legal copy on their behalf.
--
--   intakeLicenseNumber       — real-estate license # (e.g. "TX-RE-12345")
--   intakeFairHousingNotice   — agency-supplied Fair Housing statement
