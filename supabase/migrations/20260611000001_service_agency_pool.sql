-- Agency service pool.
--
-- Lets an agency own services centrally and assign them down to its member
-- providers (the model chosen for Koala-for-Agencies Phase 2).
--
--   * "agencyId"     — non-null marks a Service as part of an agency pool.
...
-- Pool listing for an agency, newest first.
