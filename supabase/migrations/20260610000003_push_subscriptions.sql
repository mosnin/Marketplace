-- Web push (VAPID) subscriptions — one row per browser/device a provider has
...
-- new lead / appointment / deal / follow-up fires.
--
...
-- Defaults true so a provider who subscribes a device starts receiving push
