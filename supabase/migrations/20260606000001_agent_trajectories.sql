...
-- meet anywhere — answering "show me every run where schedule_appointment was
-- called after appointment_completed and the draft was approved" requires a
...
CREATE TABLE IF NOT EXISTS "AgentTrajectory" (
  ...
  -- when triaging "what did Koala actually decide on this run."
  "finalSummary" TEXT,
...
-- Time-window queries per provider: "show me the last 50 runs for this space"
