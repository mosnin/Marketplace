...
--
-- A provider lives and dies by commission math: gross commission income
-- (GCI), agency split, co-agent / referral split, and what lands in their
...
--
-- paidAt is nullable — providers can plan splits while the deal is pending
...
CREATE TABLE IF NOT EXISTS "CommissionSplit" (
  ...
  party         TEXT         NOT NULL,           -- 'me' | 'agency' | 'co_agent' | 'referral_out' | 'referral_in' | 'other'
  label         TEXT         NOT NULL,           -- human label, e.g. "Sarah Lee" or "Agency split"
