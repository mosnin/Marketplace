...
-- Fixes: appointment double-booking, non-atomic space creation, non-atomic agency creation

-----------------------------------------------------------------------
-- 1. Atomic appointment booking — prevents double-booking via row-level lock
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- 3. Atomic agency + owner membership creation
-----------------------------------------------------------------------
