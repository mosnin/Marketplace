-- ═══════════════════════════════════════════════════════════════════════════
-- Routine — a standing instruction for Koala: a sentence and a time.
--
-- The provider writes one English instruction and picks how often it runs.
...
CREATE TABLE IF NOT EXISTS "Routine" (
  ...
  -- provider reads the Activity feed for what the run actually did.
