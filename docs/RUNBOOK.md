...
1. Open the public status page: `https://my.usekoala.com/status` (or the
...
| --- | --- | --- | --- |
| `lead-sla` | every 15 min | Speed-to-lead sweep: nudges the assigned provider on un-worked routed leads, escalates cold leads to the agency. | — |
| `follow-up-reminders` | daily 09:00 | Emails/texts/pushes each provider a digest of contacts whose follow-up is due. Day-locked against double-send. | — |
| `agency-weekly-report` | Mon 09:00 | Emails each active agency owner a weekly per-agent activity report. Day-locked. | — |
