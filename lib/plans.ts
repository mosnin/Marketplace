...
/** Where a plan's credit balance lives: solo/pro on the Space, team on the Agency. */
export type AccountType = 'space' | 'agency';
...
export const WORKFLOW_CREDIT_COST = {
  ...
  call_prep: 3,
  lead_score: 1,
  // One Koala chat/agent turn (the in-app assistant). Flat 1 credit — a turn's
