 ...
 * compromised provider account could burn $30/hour, $720/day, with zero
 * automated guard.
 *
 ...
 * $50/day per space — generous for a real working provider, hard ceiling
 ...
 * rather let a generation through than block a paying provider on a
