 ...
 * and that intent rots if the provider goes quiet. New is just an arrival —
 ...
 *
 * `opts.skip` (default 0): with 47 hot leads, the provider would see the same
 ...
 * the provider can cycle to the next-best subject in one tap. skip=0 picks
