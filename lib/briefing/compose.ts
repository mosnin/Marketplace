 ...
 * filler that teaches the provider to ignore tomorrow's edition.
 */
...
/**
 * The active source list. Phase A shipped three internal Koala-DB
 ...
 * follow-up from leads source for the same person); the provider sees
...
function headlineForCard(card: BriefCard): string {
  ...
  switch (kind) {
    ...
    case 'prep':
      // Upcoming appointment — "Reynolds appointment at 10:00 AM."
...
/**
 * What Koala says when the provider has nothing on fire. The right to
