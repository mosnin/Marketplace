 ...
 * surface omits the PIPELINE section on day-one providers.
 */
...
const BUCKET_OF: Record<string, string> = {
  // Drafts the provider can review / approve
 ...
 * sequence so the provider's eye lands on the most actionable item
 ...
 * surface omits the OVERNIGHT section so day-one providers don't see a
