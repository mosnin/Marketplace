 ...
 * for this provider right now, or null?"
 */
...
/**
 * Whole-provider trends — their subject string IS the category name (no
...
export async function pickBestTip(spaceId: string): Promise<Signal | null> {
  ...
  // a few). The brief's per-provider budget is generous.
