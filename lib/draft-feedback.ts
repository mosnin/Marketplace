 ...
 *
 * The agent emits a draft. The provider either ships it as written, edits
 ...
 * rewrite is the same signal as 1,000 vs. 1,000: "the provider rewrote it."
 ...
 * code-point equality, which is what we want for "did the provider change
 ...
 * neither is "Hi\n\nMaya" vs "Hi\nMaya". We measure how much the provider
