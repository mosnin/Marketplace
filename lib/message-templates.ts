 ...
 *
 * We intentionally keep the variable language dead-simple — a provider should
...
export const TEMPLATE_VARIABLES: { key: keyof TemplateContext; description: string }[] = [
  ...
  { key: 'serviceAddress',  description: 'Deal / appointment service address' },
  { key: 'appointmentDate',         description: 'Appointment date, e.g. "Sat Apr 20"' },
  { key: 'appointmentTime',         description: 'Appointment time, e.g. "2:00 PM"' },
  { key: 'closeDate',        description: 'Expected close date' },
  { key: 'providerName',      description: 'Your name' },
