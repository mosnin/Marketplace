 ...
 *   to Contact, Deal, Service, Conversation, Message, Note, Appointment, etc. We do
 ...
 *   - CommissionLedger (agency-owned financial record, not space-owned)
 *   - SupportTicket / Service pool rows that ON DELETE SET NULL rather than cascade
 *
