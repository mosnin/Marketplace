/**
 * Koala typography + spacing scale.
 *
...
/**
 * `KOALA_PILL` — primary pill for buttons that DIRECTLY invoke
 * Koala ("Tell Koala", "Ask Koala", "Koala, help with this").
 *
 ...
 * gradient so the provider feels Koala at the moment they reach for
