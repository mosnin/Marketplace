 ...
 * know about. Recovery path for providers who completed OAuth on the
...
export async function upsertByComposioId(args: {
   ...
   *  OAuth (which 401s and reads as "Koala lost my integrations"). */
 ...
 * unauthorized — typically because the provider revoked our OAuth grant on
...
export async function markExpiredByComposioId(
  ...
  // provider's already seen the truth, and a chat-time write would be
  // pure churn.
