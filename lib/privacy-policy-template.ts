...
/**
 * Generates a comprehensive privacy policy HTML template for providers and agencies.
 * Designed to protect both the entity and Koala (the platform) from liability.
 */
export function generatePrivacyPolicy(
  entityName: string,
  entityType: 'provider' | 'agency'
): string {
  const entity = escHtml(entityName || (entityType === 'agency' ? 'Our Agency' : 'Our Office'));
  const entityLabel = entityType === 'agency' ? 'agency' : 'real estate professional';
...
<p>We are the <strong>data controller</strong> responsible for the personal data we collect from you. We use Koala (my.usekoala.com), a third-party customer relationship management platform, to process data on our behalf. Koala acts solely as a <strong>data processor</strong> and does not independently control or make decisions about your personal information.</p>
...
<ul>
  ...
  <li><strong>Housing Preferences:</strong> Desired service type, location, move-in timeline, bedroom/bathroom requirements</li>
...
<ul>
  <li><strong>Lead Management:</strong> To evaluate and respond to your inquiry, match you with suitable services, and manage our client pipeline</li>
  <li><strong>Communication:</strong> To contact you via email, SMS, or phone regarding services, appointments, applications, and follow-ups</li>
  ...
  <li><strong>Appointment Scheduling:</strong> To book and manage service appointments and appointments</li>
...
<ul>
  <li><strong>Koala (my.usekoala.com):</strong> Our CRM platform that stores and processes your data on our behalf as a data processor. Koala does not sell, share, or independently use your personal data</li>
  ...
  <li><strong>Calendar Services:</strong> For scheduling and managing appointment appointments</li>
...
<ul>
  ...
  <li>With service owners or landlords in connection with rental or purchase applications you submit</li>
  <li>When required by law, regulation, or legal process</li>
  <li>To protect our rights, safety, or service, or that of others</li>
...
<p>Koala (my.usekoala.com) is a software platform that provides tools for real estate professionals to manage their client relationships. <strong>Koala is not responsible for the privacy practices of individual ${entityLabel}s or agencies that use its platform.</strong> This privacy policy is maintained by ${entity}, and all inquiries about data handling should be directed to ${entity}, not to Koala. Koala processes data solely as instructed by ${entity} and bears no independent liability for the data collection or use practices described herein.</p>
