...
/**
 * Structured provenance for runs the provider did not initiate by chat.
 ...
 * "Koala noticed because..." breadcrumb under each draft.
 */
...
export async function fireRoutineRun(
  ...
  try {
    ...
    // routine / sweep runs — the orchestrator treats null as "provider-
