 ...
 *   1. We dial the AGENT's own phone (create call). Telnyx rings the provider.
 ...
 *      it, and asks Koala for a summary.
 */
...
export interface PlaceClickToCallParams {
  ...
  /** The provider's own phone — Telnyx dials this leg first. */
  agentNumber: string;
