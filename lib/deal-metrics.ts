/**
 * Pure agency/provider performance metrics over Deal rows.
 *
 ...
 *
 * Keeping them pure means the same logic backs the forecast page, a provider
 * profile, and a Koala tool without any of them owning a query. Callers fetch
