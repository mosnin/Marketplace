...
const SUGGESTIONS_BY_TOOL: Record<string, string[]> = {
  search_contacts: ['Draft a follow-up email', 'Schedule a appointment', 'Show their deals'],
  get_contact: ['Draft an email', 'Schedule a call', 'Add a note'],
  find_person: ['Draft a follow-up', 'Add to pipeline', 'Schedule a appointment'],
  ...
  search_services: ['Schedule a appointment here', 'Find similar services', 'Save this service'],
  find_service: ['Schedule a appointment here', 'Find similar services', 'Show recent comparables'],
  add_service: ['Schedule a appointment', 'Match to interested buyers', 'Add another service'],
  ...
  check_availability: ['Schedule a appointment', 'Send these times to the lead', 'Block focus time'],
