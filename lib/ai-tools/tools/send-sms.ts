...
export const sendSmsTool = defineTool<typeof parameters, SendSMSResult>({
  ...
  riskLevel: 'high',
  description:
    'Send an SMS to a person (or free-form phone number). Always prompts for approval. Use for appointment confirmations, quick check-ins.',
  parameters,
  ...
  async handler(args, ctx) {
    ...
    // prefixes (chat-attachments/, onboarding/, service-photos/) qualify.
