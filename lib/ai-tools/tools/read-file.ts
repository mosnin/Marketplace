 ...
 * description so it doesn't quote the URL back to the provider as
 * shareable.
 */
...
export const readFileTool = defineTool<typeof parameters, ReadFileResult>({
  ...
  riskLevel: 'safe',
  description:
    'Return a 5-min signed download URL + metadata for an uploaded file. URL is private — pass to other tools (send_email attachments, attach_file_to_service) or download in this turn; do not quote as shareable.',
  parameters,
