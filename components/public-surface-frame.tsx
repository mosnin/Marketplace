 ...
 * surface: /p/[slug] (profile), /apply/[slug] (intake), /book/[slug] (appointment
 * booking), /appointment/[token] (appointment manage).
 *
 * All four surfaces are the provider's storefront for a stranger. On
 * desktop they should feel like one product family: a centred card
 * floating over a heavy-blurred image fill (the provider's cover photo or
...
export interface PublicSurfaceFrameProps {
  /** Image that fills the desktop blur canvas. Usually the provider's
   ...
   *  document state — applicants see whatever the provider branded for. */
  darkMode?: boolean;
