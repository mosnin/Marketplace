 ...
 *
 * Stylesheet anchors:
 *   - Body type uses Tailwind's `prose` so headings inherit Koala's
 ...
 *     provider can tell at a glance whether they're viewing or editing.
 */
    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          // so the provider doesn't feel a layout jump when toggling.
          ...
          // default link blue — Koala links are foreground underline.
  ...
  return (
    <div
      className={cn(
        ...
        // Read mode: subtle muted tint so the provider can tell at a glance
