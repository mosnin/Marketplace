...
const STATUSES = [
  ...
  { key: 'appointment_scheduled', label: 'Appointment Scheduled', icon: CalendarCheck, color: 'bg-orange-50 text-orange-700 dark:bg-orange-500/10 dark:text-orange-400' },
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <button
          ...
          aria-controls="provider-messages-panel"
        ...
        {showMessages && (
          <div id="provider-messages-panel" className="rounded-lg border border-border overflow-hidden">
            {/* Message list */}
            <div
              role="log"
              aria-live="polite"
