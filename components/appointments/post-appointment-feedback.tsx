...
export function PostAppointmentFeedback({ token, guestName, businessName }: PostAppointmentFeedbackProps) {
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-6 space-y-4">
      <div className="text-center space-y-1">
        <h3 className="text-lg font-semibold">How was your appointment?</h3>
