                        ...
                        {lead.sourceLabel && (
                          <>
                            ...
                            <span className="inline-flex items-center gap-1">
                              <Tag size={10} />
                              {lead.sourceLabel === 'intake-form' ? 'Intake form' : lead.sourceLabel === 'appointment-booking' ? 'Appointment booking' : lead.sourceLabel}
                            </span>
                          </>
                        )}
                ...
                <div className="px-4 pb-3 flex flex-wrap gap-1.5">
                  ...
                  {(lead.leadType === 'buyer' || lead.leadType === 'seller') ? (
                    <>
                      ...
                      {app?.serviceType && <QChip icon={Home} label={app.serviceType} />}
                  ...
                  {(app?.serviceAddress || lead.preferences) && <QChip icon={MapPin} label={app?.serviceAddress ?? lead.preferences ?? ''} />}
                </div>
