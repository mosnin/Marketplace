          ...
          <>
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="Template name (e.g. Appointment confirmation)"
            ...
            <textarea
              ...
              placeholder={"Hi {{contactFirstName}}, confirming our appointment of {{serviceAddress}} on {{appointmentDate}} at {{appointmentTime}}. Reply to reschedule."}
