...
// ─────────────────────────────────────────────────────────────────────────────
// Sidebar collapse — desktop-only icon-rail mode for the provider sidebar.
//
// State lives in localStorage under `koala.sidebar.collapsed`. To avoid an
...
const STORAGE_KEY = 'koala.sidebar.collapsed';
...
export function useSidebarCollapsed() {
  ...
  // When the sidebar isn't wrapped (e.g. agency sidebar), behave as expanded.
  if (!ctx) return { collapsed: false, animating: false, toggle: () => {} };
  return ctx;
}

// ─────────────────────────────────────────────────────────────────────────────
// Toggle button — pinned just above the user-footer divider in the provider
