...
const ACTION_LABELS: Record<string, string> = {
  ...
  packet_drafted: 'Drafted service packet',
    ...
    <div className="rounded-lg border border-border/70 bg-card overflow-hidden">
      ...
      {enabled === false && !hasActivity && !hasInsights && pendingDrafts === 0 && (
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium">Bring Koala on as your cowork</p>
            <p className="text-xs text-muted-foreground mt-0.5">
              Koala watches your leads, drafts the follow-ups, and hands them to you for a quick read.
            </p>
          </div>
          <Link
      ...
      {enabled && !hasActivity && !hasInsights && pendingDrafts === 0 && (
        <div className="flex items-center gap-3 px-5 py-4 border-b border-border">
          ...
          <div>
            <p className="text-sm font-medium">Koala is settling in</p>
