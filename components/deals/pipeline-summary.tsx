...
interface PipelineSummaryProps {
   ...
   *  KPI numbers don't go stale right after the provider adds a deal. */
  refreshKey?: number;
...
interface PipelineStats {
  ...
  /** A short Koala narration that names the most-pressing fact. */
  narration: string;
 ...
 *
 * Answers the provider's morning question — "what's actually moving, what's
...
export function PipelineSummary({
  ...
  const stats: PipelineStats = useMemo(() => {
    ...
    // Compose Koala's one-line narration. Pick the most-pressing fact.
    let narration = '';
