    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-card shadow-lg p-8 text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mx-auto leading-relaxed">
              Get full access to everything in Koala for 7 days. No credit card required to start.
            </p>
          </div>
        ...
        <p className="text-center text-xs text-muted-foreground">
          Already subscribed?{' '}
          <a href={pathname.startsWith('/agency') ? '/agency/billing' : `/s/${slug}/billing`} className="text-primary underline hover:text-primary/80">
            Manage billing
          </a>
        </p>
      </div>
