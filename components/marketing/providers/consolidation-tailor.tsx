...
/**
 * The two closing payoff sections for /providers, kept together because they
 * answer the same buyer objection from two angles: "why move?" and "will it
 * fit how I work?"
 *
 *   1. OnePlace — the data-consolidation payoff. The provider stops bouncing
 *      between six tabs; inbox, people, pipeline, calendar, services, files,
 *      and studio are one workspace, and Koala keeps them in sync. Rendered
 ...
 *
 *   2. TailorIt — repetitive work handled, fit to the provider's existing
 *      workflow. Grounded in real Koala tools: drafting in your voice,
 *      follow-ups it sets, appointments it books, the pipeline it keeps current —
...
/** Repetitive work handled, fit to how the provider already works. */
const TAILORED = [
  {
    icon: PenLine,
    title: 'drafts in your voice.',
    body: 'Koala learns how you actually write and composes the reply you would have typed, then stops for your read.',
  },
  {
    icon: Bell,
  ...
  },
  {
    ...
    body: 'approval-first on every send by default. trust a task, and hand Koala that one, per tool, on your terms.',
  },
];
