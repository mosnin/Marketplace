 ...
 *
 * The site consolidated to a handful of pages (Providers, Agencies,
  ...
  return (
    ...
    >
      <nav className="mx-auto max-w-7xl px-6 md:px-8 h-16 flex items-center justify-between">
        {/* Brand mark */}
        <Link href="/" aria-label="Koala home" className="flex items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/login/provider" className={cn(GHOST_PILL, 'hidden sm:inline-flex')}>
            Log in
          </Link>
