 ...
 *
 * Real agency marks, rendered as uniform monochrome silhouettes (black on
...
const LOGOS: Logo[] = [
  { src: '/marketing/logos/lpt.png', alt: 'Luxe Services' },
  ...
  { src: '/marketing/logos/agency4.png', alt: 'Zander Realty Group' },
];
