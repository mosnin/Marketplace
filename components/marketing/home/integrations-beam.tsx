 ...
 *
 * The provider's whole world — inbox, calendar, and the surfaces they hand to
 * clients (intake link, appointments page, public page) — beams into one agent at
 * the center. Brand-orange beams flow along each path; the hub wears the real
 * Koala mark. On a clean Koala canvas (not a foreign dark slab), so it sits
    ...
    <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
      <Reveal className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-muted-foreground">
          Your inbox and calendar feed Koala. Your intake link, appointments page, and
      ...
      >
        {/* left column — the systems Koala reads */}
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            />
            <BrandLogo className="relative h-7" alt="Koala" />
          </div>
        </div>

        {/* right column — the surfaces the provider hands to clients */}
        <div className="flex flex-col justify-center gap-8">
          <Node ref={intakeRef} icon={ClipboardList} label="Intake link" />
          <Node ref={appointmentsRef} icon={Route} label="Appointments page" />
        ...
        <AnimatedBeam containerRef={containerRef} fromRef={appointmentsRef} toRef={hubRef} {...BEAM} delay={0.9} reverse />
