...
const QUOTES = [
  { name: 'Provider name', role: 'Agent · City', body: 'Koala drafts the reply I was about to type, then waits for my tap. It feels like having an assistant who already knows my book.' },
  { name: 'Provider name', role: 'Agent · City', body: 'I stopped losing leads in my inbox. Every morning the day is already triaged for me.' },
  { name: 'Agency name', role: 'Agency · Team of 12', body: 'For the first time I can see what the whole floor is closing without nagging anyone for updates.' },
  { name: 'Provider name', role: 'Agent · City', body: 'Booked three appointments from my phone between showings. Koala handled the calendar and the confirmations.' },
  { name: 'Provider name', role: 'Agent · City', body: 'The pipeline is finally honest. I move a card and everything else just updates.' },
  { name: 'Agency name', role: 'Agency · Team of 30', body: 'Onboarding a new agent used to take a week. Now they walk in and the workspace is already running.' },
];
