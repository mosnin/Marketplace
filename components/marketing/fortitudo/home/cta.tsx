 ...
 *  and dark). Koala's locked primary action → start free trial. */
      ...
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-marketing-3xl border border-white/10 bg-[#111113] px-6 py-20 text-center sm:py-24">
        ...
        <div className="relative z-10">
          <h2 className="font-brand text-3xl text-white sm:text-4xl lg:text-5xl">
            Run your service business. <span className="text-gradient-brand">Koala does the rest.</span>
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-lg text-white/65">
            Seven days free, then your plan price. List your services, connect your inbox, and watch
            the busywork start running itself.
          </p>
