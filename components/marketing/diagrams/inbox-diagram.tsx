 ...
 *
 * One beat: the inbox rows settle in, then a Koala "Draft ready" badge
 * arrives on the top thread — the provider sees that the moment a lead
...
const ROWS = [
  { from: 'Marcus Chen', subject: 'Re: 415 Lexington appointment', time: '2m', unread: true },
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {i === 0 && (
                      <motion.span
                        ...
                        transition={{ duration: 0.22, ease: EASE_APPLE }}
                      >
                        <DiagramKoalaBadge label="Draft ready" />
                      </motion.span>
                    )}
                  </div>
