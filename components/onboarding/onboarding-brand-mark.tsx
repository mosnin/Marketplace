 ...
 * belong on the front door of the product. Now renders the actual Koala
 * logo so the moment the provider lands on setup, they see the same identity
        ...
        : size === 32
          ...
          : size === 48
            ...
            : size === 64
              ? 'h-16'
              : 'h-12';
  return <BrandLogo className={heightClass} alt="Koala" />;
}
