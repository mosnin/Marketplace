 ...
 * (`onboarding-provider-v2.tsx`). The legacy `onboarding-provider.tsx`
 * keeps its own inline copies on purpose: it's the live flow, slated
 * for deletion once V2 ships to all providers, and refactoring code
...
export type Role = 'solo' | 'team_lead' | 'agency_owner';
