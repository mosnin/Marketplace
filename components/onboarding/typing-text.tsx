 ...
 * of copy reads as if it's being written live, right now, by Koala.
 *
 * Built for the onboarding reveal (the first-touch draft Koala
 ...
 * Koala is working in front of you - so the animation is the point,
 * not decoration.
 *
