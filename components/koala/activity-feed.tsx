...
const ACTION_META: Record<string, { verb: string; icon: LucideIcon }> = {
  ...
  packet_drafted: { verb: 'drafted a service packet for', icon: Paperclip },
  ...
  // Task lifecycle (logged when a provider pauses/resumes/cancels/completes
  ...
  return (
    <div className="space-y-6">
      {/* No tab strip — the product has no tabs anywhere else. Chronological
          by default is what providers actually want; specific entries can be
