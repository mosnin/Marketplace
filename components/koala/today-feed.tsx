...
/**
 * The default surface — focus mode. One focal item at a time. The provider
 * lands on /koala and sees ONE thing waiting on them with Send / Edit /
 ...
 *
 * The provider signal said simplicity wins. This is more simplicity — five
...
export function TodayFeed({
  ...
  slug: string;
  /** True when the provider has done nothing yet — triggers day-one welcome. */
  isFresh?: boolean;
  firstName?: string;
