...
interface RightPanelProps {
  slug: string;
  activeTab: 'people' | 'deals' | 'services';
  onTabChange: (tab: 'people' | 'deals' | 'services') => void;
  className?: string;
}
...
// Services grid) — no nested sidebar, no nested header, no nested chat
