...
/**
 * The brief is a moment, not a surface. It exists to wake the provider
 ...
 * provider doesn't lose the brief mid-read by accident.
 */
...
interface UseBriefLifecycleArgs {
  ...
  /** Manual collapse override — set true when the provider explicitly
...
export function formatProgress(
  ...
  // The receipt has to sound like a provider would talk about their
