    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          disabled={!isOwner}
        />
        <p className={CAPTION}>Optional. Shown on your agency profile.</p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div
          ...
          onClick={() => isOwner && document.getElementById('agency-logo-upload')?.click()}
        >
          {logoUrl ? (
        ...
        <input
          ...
          onChange={async (e) => {
            ...
            try {
              ...
              // Use onboarding upload endpoint — agency-only accounts may not have a Space
      ...
      <div className="space-y-3 pt-3">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className={CAPTION}>Shown on intake pages for providers under your agency.</p>
          </div>
          {isOwner && (
            <button
              type="button"
              onClick={() => {
                setPrivacyPolicyHtml(generatePrivacyPolicy(name, 'agency'));
        ...
        <RichTextEditor
          ...
          placeholder="Enter your agency privacy policy here or click 'Generate template' to start..."
          disabled={!isOwner}
        />
        <p className={CAPTION}>
