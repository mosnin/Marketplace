...
/**
 * Agency member profile form — an owner/admin's own profile within the
 * agency. Mirror of the provider profile-section (display name, title, bio,
 * photo, phone) but persisted per-member on AgencyMembership via
 * /api/agency/profile (self-scoped). Photo uploads use /api/upload/onboarding
 * (works for agency-only accounts with no Space).
 */
    ...
    <form onSubmit={handleSave} className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          <button
            type="button"
            onClick={() => document.getElementById('agency-profile-photo')?.click()}
      ...
      <div className="space-y-1.5">
        <Label htmlFor="agency-display-name" className="text-[12.5px] font-medium text-foreground">
          Display name
        </Label>
        <Input
      ...
      <div className="space-y-1.5">
        <Label htmlFor="agency-title" className="text-[12.5px] font-medium text-foreground">
          Title
        </Label>
        <Input
          id="agency-title"
          ...
          placeholder="Managing Agency"
        />
      </div>

      <div className="space-y-1.5">
        <Label htmlFor="agency-phone" className="text-[12.5px] font-medium text-foreground">
          Phone number
        </Label>
        <Input
          id="agency-phone"
      ...
      <div className="space-y-1.5">
        <Label htmlFor="agency-bio" className="text-[12.5px] font-medium text-foreground">
          Bio
        </Label>
        <Textarea
          id="agency-bio"
          ...
          placeholder="A short bio shown alongside your name in the agency."
          rows={3}
        />
      </div>
