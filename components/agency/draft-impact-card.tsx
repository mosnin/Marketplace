...
/**
 * "Draft impact" — single card on the agency dashboard. Reports how Koala's
 * drafts landed across the agency over the trailing 30 days.
 *
...
function DraftImpactBody({ stats }: { stats: DraftStats }) {
  ...
  // nothing for the agency to misread as "Koala is broken."
  if (stats.total === 0) {
    return (
    ...
    <>
      ...
      {hasOutcome && (
        <p className="text-xs text-muted-foreground">
          Correlation only — the deal moved after the draft sent. Koala didn&apos;t
