 ...
 * three Koala/agent leaf-component directories where the orange is
...
function scanForOrange(file: string): Violation[] {
  ...
  // If the file imports brandOrange OR KOALA_PILL, the orange usages
