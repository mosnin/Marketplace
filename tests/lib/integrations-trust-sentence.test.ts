 ...
 *
 * The sentence is the answer to a provider's actual fear ("am I handing
 * Koala the keys to my inbox?"). Drive-by copy edits that soften it back
 ...
 * Settings Connections tab in the Koala dropdown reorg (the dropdown is
...
const TRUST_PHRASE = 'Koala never sends without your tap.';

describe('settings connections — trust sentence', () => {
  it('contains the provider-facing consent line', () => {
